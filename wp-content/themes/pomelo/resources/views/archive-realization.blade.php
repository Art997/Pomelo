{{--
  Template Name: Archive Realization
--}}

@extends('layouts.app')

@section('content')
  <section id="realization-1" data-scroll-section>
    <div class="container-fluid" >
        <div class="row">
            <div class="col-xl-12">
                <p data-scroll data-scroll-speed="2.1">
            ...
            <div class="col-xl-12">
                <div class="container-category-realization" >
                    <ul class="realization-list">
                        ...
                        <li class="realization-item">Identyfikacja wizualna</li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-12">
  ...
  <section id="realization-3"  data-scroll-section>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12"><h3>Inne realizacje</h3></div>
            <div class="col-xl-12">
                <div class="container-ul-realization">
                    <ul>
                        <li class="category-other-realizations">
                            <div class="container-other-realization-single">
                                <div class="other-realization-single-title">Marka</div>
                                <div class="other-realization-single-category">Kategoria</div>
                            </div>
                        </li>
                        <a href="">
                            ...
                            <li>
                                <div class="container-other-realization-single">    
                                    <div class="other-realization-single-title">Lorem ipsum Marka</div>
                                    <div class="other-realization-single-category">Strona</div>
                                </div>
                            </li>
                        </a>
                        <a href="">
  ...
  <section id="realization-4"  data-scroll-section>
    <div class="container-fluid">
        <div class="row">
